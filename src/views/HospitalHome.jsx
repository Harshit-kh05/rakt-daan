  ...
  async function search(e) {
    ...
    if (bloodToBeSearched.selectedBloodGroup !== "select") {
      ...
      for (let i = 1; i <= b_count; ++i) {
        ...
        const bloodStatusCount = await contract.methods
          .getBloodStatusCount(i)
          .call();
        const bloodStatus = await contract.methods
          .getBloodStatus(i, bloodStatusCount)
          .call();
      ...
      var nearestBloodData = await contract.methods
        .getBloodData(nearestBlood[0])
        .call();

      var nearestBloodStatusCount = await contract.methods
        .getBloodStatusCount(nearestBlood[0])
        .call();
      var nearestBloodStatus = await contract.methods
        .getBloodStatus(nearestBlood[0], nearestBloodStatusCount)
        .call();
    ...
    <>
      ...
      <div className="wrapper p-10 mb-2">
        <div className="page-header">
          ...
          />
          <ProfileCard name={user.name} type={user.add} bloodCount={{}} />
